...
function getTotalVolumeLocked() {
    return __awaiter(this, void 0, void 0, function* () {
        const client = new sdk_1.AldrinApiPoolsClient();
        const tvl = yield client.getTotalVolumeLocked();
        console.log('TVL: ', tvl);
        const poolsInfo = yield client.getPoolsInfo();
